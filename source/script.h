...
#define ERR_DUPLICATE_FUNCTION _T("Duplicate function definition")
...
public:
	...
	ResultType PreprocessGlobalVars();
	ResultType PreprocessGlobalVars(Var** aVarList, int aVarCount);
