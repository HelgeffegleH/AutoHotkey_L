...
// Returns the number of non-comment lines that were loaded, or LOADING_FAILED on error.
{
	...
	auto mod = g_CurrentModule; // PreprocessLocal/GlobalVars might change this
...
process_completed_line:
		...
		if (LPTSTR module_name = IsModuleDefinition(buf))
		{
...
// Returns OK or FAIL.
{
	...
	{
		0,0,0,0,0,0,0,0,0  // SYM_STRING, SYM_INTEGER, SYM_FLOAT, SYM_MISSING, SYM_VAR, SYM_MODULE, SYM_OBJECT, SYM_DYNAMIC, SYM_BEGIN (SYM_BEGIN must be lowest precedence).
